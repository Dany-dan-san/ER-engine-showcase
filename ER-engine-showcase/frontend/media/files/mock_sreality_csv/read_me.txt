...
- The input file must be a .CSV file and must mandatorily be named 'sreality_listings'
- Make sure that all rows have complete information. 
- Respect the data type and format, as shown in the mock .CSV file. 
- Ensure that the .CSV file contains no other tab but 'data', where you list 
  the information under the appropriate columns. 
- Do not change the column names.
- Ensure the street names are properly written, accents and case do not matter.
